...
public class WorkmatePickedRestaurant {
    ...
    public WorkmatePickedRestaurant() {
    }

    public WorkmatePickedRestaurant(String restaurantId, String restaurantName, String restaurantAddress, Timestamp restaurantDateChoice) {
